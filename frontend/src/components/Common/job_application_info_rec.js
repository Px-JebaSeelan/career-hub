...
export default class Job_application_info extends Component {
    ...
    componentDidMount() {
        if (localStorage.getItem('user_type') !== "recruiter" && localStorage.getItem("isloggedin") !== true) {
            ...
            axios.post(API_URL + '/application/all_my_non-rejected_applications_of_perticular_job', chunk)
                .then(res => {
    ...
    async reject(id, mail) {
        axios.post(API_URL + '/application/reject_an_application', { id: id })
            .then(res => {
                console.log(res.data)
            })
            .catch(err => {
        ...
        axios.post(API_URL + '/application/decrement_application_count', { email: mail })
            .then(res => {
                console.log(res.data);
            })
            .catch(err => {
    ...
    accept(id) {
        axios.post(API_URL + '/application/accept_an_application', { id: id })
            .then(res => {
                console.log(res.data)
            })
            .catch(err => {
    ...
    shortlist(id) {
        axios.post(API_URL + '/application/shortlist_an_application', { id: id })
            .then(res => {
                console.log(res.data)
            })
            .catch(err => {
                    ...
                    <tbody>
                        {
                            this.state.applications.map((application, i) => {
                                ...
                                if (application.education_applicant && application.education_applicant.length > 0) {
                                    educationDisplay = application.education_applicant.map((edu, j) => (
                                        <div key={j}>
